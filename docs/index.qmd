...
-   Australia in original 155 countries, not in updated estimates.


## An alternative approach: `conmat`

- We developed an *open-source* approach the R package `conmat`, that can be applied to any input population (big or small).
...
-   Demonstrate using other social contact diaries
